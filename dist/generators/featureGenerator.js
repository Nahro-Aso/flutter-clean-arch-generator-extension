...
async function generateFeatureFiles(workspaceFolder, featureName, packageName, providerType, modifiers) {
    ...
    await (0, presentationLayer_1.generatePresentationLayer)(featurePath, featureName, capitalized, packageName, providerName, providerType, modifiers);

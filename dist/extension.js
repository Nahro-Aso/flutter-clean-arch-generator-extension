...
function activate(context) {
    ...
    let generateFiles = vscode.commands.registerCommand('riverpod-clean-arch.generate', () => __awaiter(this, void 0, void 0, function* () {
        var _a;
        ...
        try {
            ...
            // Example:
            yield (0, featureGenerator_1.generateFeatureFiles)(workspaceFolder, featureName);

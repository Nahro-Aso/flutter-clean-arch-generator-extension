...
generate_mapper() {
    ...
    "import 'package:${package_name}/features/${feature_name}/domain/entities/${feature_name}_entity.dart';
import 'package:${package_name}/features/${feature_name}/data/dto/${feature_name}_dto.dart';

...
export async function generateBarrelFiles(
  ...
  await writeFile(
    `${featurePath}/domain/domain.dart`,
  ...
  await writeFile(
    `${featurePath}/presentation/presentation.dart`,
  ...
  await writeFile(
    `${featurePath}/presentation/providers/providers.dart`,

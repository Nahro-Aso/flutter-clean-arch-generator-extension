...
import { generateEntity } from './domain/generateEntity';
import { generateRepository } from './domain/generateRepository';
import { generateUseCase } from './domain/generateUseCase';

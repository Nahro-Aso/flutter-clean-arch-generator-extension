...
export async function generateDataLayer(
    ...
    await generateRemoteDataSource(featurePath, featureName, capitalized, providerName);
    await generateLocalDataSource(featurePath, featureName, capitalized, providerName);
    ...
    await generateRepositoryImpl(featurePath, featureName, capitalized, packageName);
}

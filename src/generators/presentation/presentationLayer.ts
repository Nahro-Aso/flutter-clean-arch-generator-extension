...
export async function generatePresentationLayer(
    ...
    await generatePage(featurePath, featureName, capitalized, packageName, providerName);
    await generateNotifier(featurePath, featureName, capitalized, packageName, providerName);
}

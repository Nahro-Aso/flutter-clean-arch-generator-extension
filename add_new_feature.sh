...
create_feature() {
    ...
    local package_name="your_package_name"
    ...
    generate_repository "$feature_name" "$capitalized_feature_name" "$package_name" "$provider_name"
    generate_repository_impl "$feature_name" "$capitalized_feature_name" "$package_name" "$provider_name"
    ...
    generate_mapper "$feature_name" "$capitalized_feature_name" "$package_name"
    echo "  ✅ Data Layer complete"

    echo "  📝 Generating Domain Layer..."
    generate_entity "$feature_name" "$capitalized_feature_name"
    generate_use_case "$feature_name" "$capitalized_feature_name" "$package_name" "$provider_name"
    echo "  ✅ Domain Layer complete"

    echo "  📝 Generating Presentation Layer..."
    generate_notifier "$feature_name" "$capitalized_feature_name" "$package_name" "$provider_name"
    generate_page "$feature_name" "$capitalized_feature_name" "$package_name" "$provider_name"
